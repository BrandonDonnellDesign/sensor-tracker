      ...
      <div className="space-y-3 mb-6">
        {onRefresh && (
          <button
            ...
            className={`flex items-center justify-center w-full font-medium py-3 px-4 rounded-xl transition-all duration-200 ${
              isRefreshing
                ? 'bg-gray-50 dark:bg-slate-800 text-gray-400 dark:text-slate-500 cursor-not-allowed'
                : 'bg-gray-100 dark:bg-slate-700 hover:bg-gray-200 dark:hover:bg-slate-600 text-gray-900 dark:text-slate-100 hover:scale-105'
            }`}
          >
            <svg
            ...
            {!isRefreshing && (
              <kbd className="ml-auto bg-gray-200 dark:bg-slate-600 px-2 py-1 rounded text-xs">Alt+R</kbd>
            )}
          </button>
        )}
