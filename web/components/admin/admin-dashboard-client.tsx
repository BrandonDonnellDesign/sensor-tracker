  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          ...
          <button
            ...
            disabled={refreshing}
            className="flex items-center space-x-2 px-4 py-2 text-sm font-medium text-slate-300 bg-[#1e293b] border border-slate-700 rounded-lg hover:bg-[#2d2e4a] transition-colors disabled:opacity-50"
          >
        ...
        {quickStats.map((stat, index) => {
          ...
          return (
            <motion.div
              ...
              className="bg-[#1e293b] rounded-lg border border-slate-700/30 p-5 hover:border-slate-600/50 transition-all"
            >
          ...
          {adminActions.map((action, index) => {
            ...
            return (
              ...
              >
                <Link
                  href={action.href}
                  className="bg-[#1e293b] rounded-lg border border-slate-700/30 p-5 hover:border-slate-600/50 hover:bg-[#2d2e4a] transition-all duration-200 group block h-full"
                >
                  <div className="flex flex-col items-center text-center space-y-3">
                    <div className={`w-11 h-11 ${action.color} rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform`}>
                      <Icon className="w-5 h-5 text-white" />
                    </div>
                    <div>
                      <h3 className="text-base font-semibold text-white group-hover:text-blue-400 transition-colors mb-1.5">
                        {action.name}
                      </h3>
      ...
      >
        ...
        <div className="bg-[#1e293b] rounded-lg border border-slate-700/30 overflow-hidden">
              ...
              {recentActivity.map((activity, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`p-5 hover:bg-[#2d2e4a] transition-colors ${
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between mb-1">
                          <h4 className={`text-sm font-medium truncate ${
                            ...
                            {activity.action}
                            {isImportant && (
                              <span className="ml-2 inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-red-500/20 text-red-300 border border-red-500/30">
                                Attention
                              </span>
                            )}
                          </h4>
