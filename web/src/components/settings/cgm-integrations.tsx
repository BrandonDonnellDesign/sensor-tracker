...
function IntegrationCard({ title, description, icon, features }: IntegrationCardProps) {
  return (
    <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700 p-6">
      ...
      <div className="space-y-2">
        {features.map((feature, index) => (
          <div key={index} className="flex items-center text-gray-600 dark:text-slate-400 text-sm">
    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600 dark:text-slate-400 text-lg leading-relaxed max-w-2xl mx-auto mb-8">
          Automatic sensor data sync from your CGM devices is currently in development. 
          These features will allow you to automatically import sensor information, eliminating manual entry.
        </p>
      </div>
      ...
      <div className="text-center bg-gray-50 dark:bg-slate-700/50 rounded-lg p-6">
        ...
        <p className="text-sm text-gray-500 dark:text-slate-500">
          Stay tuned for updates in future releases. These integrations will make managing your diabetes data effortless.
        </p>
      </div>
    </div>
  );
