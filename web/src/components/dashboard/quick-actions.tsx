    ...
    <div className="card">
      ...
      <div className="space-y-3">
        ...
        <Link
          ...
          className="flex items-center justify-center w-full text-blue-600 hover:text-blue-700 border border-blue-200 hover:border-blue-300 bg-blue-50 hover:bg-blue-100 font-medium py-2 px-4 rounded-lg transition-colors"
        >
          <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
