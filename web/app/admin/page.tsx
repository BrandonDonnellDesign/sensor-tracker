...
import { Users, Activity, Zap, Bell, TrendingUp, AlertTriangle, CheckCircle, Award, MessageSquare, Gauge } from 'lucide-react';
  ...
  return (
    <AdminGuard>
      <div className="space-y-6">
        ...
        {/* Integration Health, Notifications & Performance */}
        ...
        <div className="bg-white dark:bg-slate-800 shadow rounded-lg p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-medium text-gray-900 dark:text-slate-100">Quick Actions</h3>
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
              <span className="text-xs text-gray-500 dark:text-slate-500">All systems operational</span>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
            ...
            >
              ...
              <h4 className="font-medium text-gray-900 dark:text-slate-100">Performance</h4>
              <p className="text-sm text-gray-600 dark:text-slate-400 mt-1">System metrics & monitoring</p>
            </a>
            <a
            ...
            <a
              ...
              className="p-4 border border-gray-200 dark:border-slate-600 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors"
            >
              <Gauge className="h-5 w-5 text-cyan-600 dark:text-cyan-400 mb-2" />
              <h4 className="font-medium text-gray-900 dark:text-slate-100">Performance</h4>
              <p className="text-sm text-gray-600 dark:text-slate-400 mt-1">Monitoring, optimization & maintenance</p>
            </a>
            <a
              href="/admin/community"
              className="p-4 border border-gray-200 dark:border-slate-600 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors"
            >
              <MessageSquare className="h-5 w-5 text-blue-600 dark:text-blue-400 mb-2" />
              <h4 className="font-medium text-gray-900 dark:text-slate-100">Community</h4>
              <p className="text-sm text-gray-600 dark:text-slate-400 mt-1">Tips, comments & moderation</p>
            </a>
            <a
              href="/admin/feedback"
              className="p-4 border border-gray-200 dark:border-slate-600 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors"
